            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="video-container">
                        ...
                        <video id="my-video" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="auto" width="688" poster="{{ asset('images/poster.png') }}" data-setup='{"nativeControlsForTouch": true}'>
